...
const App = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_xisk1tx', 'template_uc0wukl', formData, 'ehAeUvLmBUfQe_tEF')
      .then((response) => {
            ...
            <div>
              ...
              <div className="box4">
                <p>
                  ...
                  test autonomous portions. We use different tools to create controls for the robots.
                </p>
              </div>
            </div>
          </div>
